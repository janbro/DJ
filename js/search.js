    ...
    case 'YouTube':
      ...
      request.execute(function(response) {
        ...
        for(var i=0;i<response.result.items.length;i++){
          ...
          $('#search-container').append('<iframe id="player" style="display: block;margin-left: auto;margin-right: auto;" type="text/html" width="854" height="480" src="http://www.youtube.com/embed/'+response.result.items[i].id.videoId+'?enablejsapi=1" frameborder="0"></iframe><br>');
      ...
      SC.get('/tracks', {
        ...
        for(var i=0;i<tracks.length;i++){
          ...
          if(tracks[i].embeddable_by=='all'){
            ...
            $('<div id="widget'+i+'"></div>').appendTo('#search-container');
